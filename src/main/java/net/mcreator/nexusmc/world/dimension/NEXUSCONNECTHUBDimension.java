...
package net.mcreator.nexusmc.world.dimension;
...
public class NEXUSCONNECTHUBDimension {
	...
	public static class DimensionSpecialEffectsHandler {
		...
		public static void registerDimensionSpecialEffects(RegisterDimensionSpecialEffectsEvent event) {
			...
			event.register(new ResourceLocation("nexus:nexusconnecthub"), customEffect);
		}
	}
}
