...
public class NEXUSsusRenderer extends HumanoidMobRenderer<NEXUSsusEntity, HumanoidModel<NEXUSsusEntity>> {
	public NEXUSsusRenderer(EntityRendererProvider.Context context) {
